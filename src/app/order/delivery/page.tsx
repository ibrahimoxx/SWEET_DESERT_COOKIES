...
export const metadata: Metadata = {
  title: "Delivery | Sweet Desert",
  description: "Get Sweet Desert delivered straight to your door.",
};
    ...
    <section className="flex min-h-[60vh] flex-col items-center justify-center py-16 sm:py-24">
      <div className="mx-auto max-w-xl px-4 text-center sm:px-6">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Get Sweet Desert delivered fresh, right to your door. Available at
        ...
        <p className="mt-6 text-sm text-gray-400">
          Delivery availability varies by location. Online ordering coming soon.
        </p>
      </div>
    </section>
  );
