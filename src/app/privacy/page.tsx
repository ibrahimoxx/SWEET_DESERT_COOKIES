    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      <div className="prose mt-8 max-w-none text-gray-600">
        ...
        <p>
          ...
          when you register for an account, place an order, subscribe to our
        ...
        <p>
          We use the information we collect to process transactions, send order
          confirmations, improve our website and services, personalize your
